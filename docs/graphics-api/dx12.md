...
```bash
# The DX12/Vulkan C++ backends are in `native/littcore/
# Native C/C++ core: native\build.bat (Windows) or: make -C native
```

## Architecture

```
native/littcore/          # Backend abstraction trait
native/littcore/dx12/src/
