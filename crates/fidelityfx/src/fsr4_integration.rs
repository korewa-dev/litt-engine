...
pub struct Fsr4Desc {
    ...
    /// AI reconstruction enabled (1 = on; bool is not Pod, stored as u32)
    pub ai_reconstruction: u32,
    /// Frame generation enabled (1 = on)
...
impl Fsr4Pipeline {
    ...
    pub fn detect_support(instance: &ash::Instance, physical: vk::PhysicalDevice) -> Fsr4Support {
    ...
    pub fn configure_upscale(&mut self, quality: Fsr4Quality, ai_recon: bool) {
        ...
        self.desc.ai_reconstruction = ai_recon as u32;
        self.desc.frame_generation = 0;
        self.is_ready = true;
    }
    ...
    pub fn configure_framegen(&mut self, quality: Fsr4Quality) {
        ...
        self.desc.ai_reconstruction = 0;
        self.desc.frame_generation = 1;
        self.is_ready = true;
    }
...
impl From<&Fsr4Desc> for Fsr4Constants {
    fn from(desc: &Fsr4Desc) -> Self {
        Self {
            ...
            ai_reconstruction: desc.ai_reconstruction,
            frame_generation: desc.frame_generation,
            _pad: [0; 4],
        }
    }
}
