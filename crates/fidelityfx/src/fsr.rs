...
use litt_math::*;
use litt_vulkan::{GpuAllocator, Allocation, AllocFlags, create_compute_pipeline, PipelineCache};
...
fn create_create_descriptor_layout(device: &Device) -> Result<vk::DescriptorSetLayout, String> {
    ...
    let info = vk::DescriptorSetLayoutCreateInfo { binding_count: bindings.len() as u32, p_bindings: bindings.as_ptr(), ..Default::default() };
    let layout = unsafe {
        device.create_descriptor_set_layout(&info, None)
...
unsafe fn build_compute_pipeline(
    ...
    let shader_info = vk::ShaderModuleCreateInfo { code_size: fallback_spv.len() * 4, p_code: fallback_spv.as_ptr(), ..Default::default() };
...
impl Fsr3Pipeline {
    ...
    pub fn new() -> Self {
        Self {
            device: unsafe { std::mem::zeroed::<ash::Device>() },
    ...
    pub fn run_create(
        ...
        let set_alloc = vk::DescriptorSetAllocateInfo {
            ...
            p_set_layouts: [desc_layout].as_ptr(),
            ..Default::default()
        };
        let desc_set = unsafe {
        ...
        unsafe {
            ...
            self.device.cmd_push_constants(
                ...
                bytemuck::cast_slice(&[
                    ...
                    constants.sharpeness.to_bits(),
                    constants.contrast.to_bits(),
                    constants.alpha.to_bits(),
                    constants.beta.to_bits(),
                ]),
            );
        ...
        unsafe {
            ...
            self.device.cmd_push_constants(
                ...
                bytemuck::cast_slice(&[
                    ...
                    constants.output_width,
                    constants.output_height,
                    constants.motion_scale.to_bits(),
                    constants.temporal_stability.to_bits(),
                    constants.flow_scale.to_bits(),
                    constants.flow_range.to_bits(),
                ]),
            );
            let groups_x = (constants.output_width + 7) / 8;
            let groups_y = (constants.output_height + 7) / 8;
...
impl CasPipeline {
    ...
    pub unsafe fn initialize(
        ...
        let pool_sizes = vec![
            vk::DescriptorPoolSize {
                ty: vk::DescriptorType::COMBINED_IMAGE_SAMPLER, descriptor_count: 16,
            },
            vk::DescriptorPoolSize {
                ty: vk::DescriptorType::STORAGE_IMAGE, descriptor_count: 16,
            },
        ];
        let pool_info = vk::DescriptorPoolCreateInfo { max_sets: 8, pool_size_count: pool_sizes.len() as u32, p_pool_sizes: pool_sizes.as_ptr(), ..Default::default() };
        let pool = device.create_descriptor_pool(&pool_info, None)
    ...
    pub fn run(
        ...
        let set_alloc = vk::DescriptorSetAllocateInfo { descriptor_pool: pool, descriptor_set_count: 1, p_set_layouts: [desc_layout].as_ptr(), ..Default::default() };
        let desc_set = unsafe {
            self.device.allocate_descriptor_sets(&set_alloc)
...
impl RayReconstruction {
    pub fn new(width: u32, height: u32) -> Self {
        Self {
            ...
            descriptor_pool: None, device: unsafe { std::mem::zeroed::<ash::Device>() },
    ...
    pub unsafe fn initialize(
        ...
        let pool_sizes = vec![
            ...
            vk::DescriptorPoolSize {
                ty: vk::DescriptorType::STORAGE_IMAGE, descriptor_count: 8,
            },
        ];
        let pool_info = vk::DescriptorPoolCreateInfo { max_sets: 4, pool_size_count: pool_sizes.len() as u32, p_pool_sizes: pool_sizes.as_ptr(), ..Default::default() };
        let pool = device.create_descriptor_pool(&pool_info, None)
        ...
        unsafe {
            ...
            self.device.cmd_push_constants(
                ...
                bytemuck::cast_slice(&[
                    ...
                    self.constants.temporal_scale.to_bits(), self.constants.blend.to_bits(),
                    self.constants.confidence_threshold.to_bits(), 0.0f32.to_bits(),
                ]),
            );
...
impl PathTracerPipeline {
    ...
    pub unsafe fn initialize(
        ...
        let pool_sizes = vec![
            vk::DescriptorPoolSize {
                ty: vk::DescriptorType::STORAGE_BUFFER, descriptor_count: 32,
            },
            vk::DescriptorPoolSize {
                ty: vk::DescriptorType::STORAGE_IMAGE, descriptor_count: 16,
            },
        ...
        unsafe {
            ...
            self.device.cmd_push_constants(
                ...
                bytemuck::cast_slice(&[
                    ...
                    constants.camera_pos_x.to_bits(),
                    constants.camera_pos_y.to_bits(),
                    constants.camera_pos_z.to_bits(),
                    constants.camera_yaw.to_bits(),
                    constants.camera_pitch.to_bits(),
                    constants.fov.to_bits(),
                    constants.aspect.to_bits(),
...
// -- manual Debug impls (ash::Device and litt_vulkan::PipelineCache are not Debug) --
macro_rules! impl_pipeline_debug {
    ($($t:ty),* $(,)?) => {
        $(
...
impl_pipeline_debug!(Fsr3Pipeline, CasPipeline, RayReconstruction, DiffuseDenoiser, SpecularDenoiser, PathTracerPipeline, DisplayPipeline);
